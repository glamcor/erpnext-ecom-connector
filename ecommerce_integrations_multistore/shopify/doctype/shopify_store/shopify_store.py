...
def setup_custom_fields():
	...
	custom_fields = {
		...
		"Address": [
			...
			dict(
				fieldname="custom_recipient_name",
				label="Recipient Name",
				fieldtype="Data",
				insert_after=ADDRESS_ID_FIELD,
				description="Shipping recipient name from Shopify (may differ from customer for drop-ship orders)",
			),
			dict(
				fieldname="custom_company_name",
				label="Recipient Company",
				fieldtype="Data",
				insert_after="custom_recipient_name",
				description="Company name from Shopify shipping address",
			),
			dict(
